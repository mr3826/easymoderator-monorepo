...
| Webhook Callback URL | `https://api.easymod.tech/api/webhooks/meta` |
| Webhook Verify Token | Value of production `META_WEBHOOK_VERIFY_TOKEN` |
| Data Deletion Request Callback URL | `https://api.easymod.tech/api/webhooks/meta/data-deletion` |
| Deauthorize Callback URL | `https://api.easymod.tech/api/webhooks/meta/deauthorize` |
| Valid OAuth Redirect URI | `https://app.easymod.tech/app/channels/oauth-callback` — must match production `META_OAUTH_REDIRECT_URI` exactly |
