...
export const apiClient = {
  ...
  approveAiDraft: conversationDomain.approveAiDraft,
  dismissAiDraft: conversationDomain.dismissAiDraft,
  markConversationRead: conversationDomain.markConversationRead,
