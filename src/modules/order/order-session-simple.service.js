...
const OrderSession = require('./order-session-simple.entity');
...
class OrderSessionService {
    ...
    static async startOrderSession(data) {
        ...
        // Default AI settings for now (will be enhanced later)
        ...
        switch (current_step) {
            ...
            case 'COLLECTING_ADDRESS':
                ...
                if (address.length >= 10) {
                    ...
                    // Default delivery zone for now (will be enhanced with RAG)
